                ...
                <div class="p-6 bg-gray-900 dark:bg-gray-800 border-b border-gray-700 dark:border-gray-600">
                    ...
                    <form action="{{ route('restaurant.menu.update', $menuItem) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="description" name="description" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-400 leading-tight focus:outline-none focus:shadow-outline">{{ $menuItem->description }}</textarea>
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <select id="menu" name="menu_id" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-400 leading-tight focus:outline-none focus:shadow-outline">
                                @foreach ($menus as $menu)
                                    <option value="{{ $menu->id }}" {{ $menuItem->menu_id == $menu->id ? 'selected' : '' }}>{{ $menu->name }}</option>
                                @endforeach
                            </select>
                        </div>
